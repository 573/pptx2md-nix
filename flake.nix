{
  ...
  inputs = {
    ...
    pptx2md = {
      url = "github:ssine/pptx2md";
      flake = false;
    };
  };

  outputs = { self, nixpkgs, flake-utils, poetry2nix, pptx2md }:
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells = {
          ...
          poetry = pkgs.mkShell {
	    # https://github.com/MordragT/nix-templates/blob/master/python-poetry/flake.nix
            packages = [
